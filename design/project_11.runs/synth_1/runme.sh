...
HD_PWD='C:/ZCU702_Projects/ZCU702_memristor/design/project_11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memristor_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memristor_wrapper.tcl
