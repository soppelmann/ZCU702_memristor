...
HD_PWD='C:/ZCU702_Projects/ZCU702_memristor/design/project_11.runs/memristor_DA4_SPI_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memristor_DA4_SPI_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memristor_DA4_SPI_0.tcl
