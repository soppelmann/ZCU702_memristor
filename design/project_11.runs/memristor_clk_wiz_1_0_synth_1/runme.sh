...
HD_PWD='C:/ZCU702_Projects/ZCU702_memristor/design/project_11.runs/memristor_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memristor_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memristor_clk_wiz_1_0.tcl
