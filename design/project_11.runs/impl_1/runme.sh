...
HD_PWD='C:/ZCU702_Projects/ZCU702_memristor/design/project_11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memristor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source memristor_wrapper.tcl -notrace
