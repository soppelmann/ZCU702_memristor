...
>>>>>>> ecc26b050c5f879286fbf40215dbf6737c58d8e1
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net iop_pmodb_M_AXI [get_bd_intf_pins iop_pmodb/M_AXI] [get_bd_intf_pins ps7_0_axi_periph/S01_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M09_AXI [get_bd_intf_pins iop_pmodb/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M10_AXI [get_bd_intf_pins ps7_0_axi_periph/M10_AXI] [get_bd_intf_pins system_interrupts/s_axi]
...
=======
  connect_bd_net -net Net [get_bd_pins mb_iop_pmodb_intr_ack/Din] [get_bd_pins mb_iop_pmodb_reset/Din]
  connect_bd_net -net PGA_GPIO_gpio_io_o [get_bd_ports ex_PGA_sync] [get_bd_pins PGA_GPIO/gpio_io_o]
  connect_bd_net -net S01_ARESETN_1 [get_bd_pins iop_pmodb/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S01_ARESETN]
...
>>>>>>> ecc26b050c5f879286fbf40215dbf6737c58d8e1
  ...
  connect_bd_net -net iop_interrupts_dout [get_bd_pins iop_interrupts/dout] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net iop_pmodb_intr_req [get_bd_pins iop_interrupts/In1] [get_bd_pins iop_pmodb/intr_req]
...
=======
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ADC_1/s_axi_aresetn] [get_bd_pins ADC_2/s_axi_aresetn] [get_bd_pins ADC_3/s_axi_aresetn] [get_bd_pins ADC_4/s_axi_aresetn] [get_bd_pins CTRL_WEST/s_axi_aresetn] [get_bd_pins DA4_GPIO/s_axi_aresetn] [get_bd_pins DA4_SPI/s_axi_aresetn] [get_bd_pins PGA_GPIO/s_axi_aresetn] [get_bd_pins PGA_SPI/s_axi_aresetn] [get_bd_pins iop_pmodb/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins ps7_0_axi_periph/M10_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_interrupts/s_axi_aresetn]
...
>>>>>>> ecc26b050c5f879286fbf40215dbf6737c58d8e1
  ...
  assign_bd_address -offset 0x41800000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs system_interrupts/S_AXI/Reg] -force
  assign_bd_address -offset 0x41220000 -range 0x00010000 -target_address_space [get_bd_addr_spaces iop_pmodb/mb/Data] [get_bd_addr_segs ADC_1/S_AXI/Reg] -force
  assign_bd_address -offset 0x41230000 -range 0x00010000 -target_address_space [get_bd_addr_spaces iop_pmodb/mb/Data] [get_bd_addr_segs ADC_2/S_AXI/Reg] -force
  assign_bd_address -offset 0x41240000 -range 0x00010000 -target_address_space [get_bd_addr_spaces iop_pmodb/mb/Data] [get_bd_addr_segs ADC_3/S_AXI/Reg] -force
  assign_bd_address -offset 0x41250000 -range 0x00010000 -target_address_space [get_bd_addr_spaces iop_pmodb/mb/Data] [get_bd_addr_segs ADC_4/S_AXI/Reg] -force
  assign_bd_address -offset 0x41260000 -range 0x00010000 -target_address_space [get_bd_addr_spaces iop_pmodb/mb/Data] [get_bd_addr_segs DA4_GPIO/S_AXI/Reg] -force
  assign_bd_address -offset 0x41E00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces iop_pmodb/mb/Data] [get_bd_addr_segs DA4_SPI/AXI_LITE/Reg] -force
  assign_bd_address -offset 0x41270000 -range 0x00010000 -target_address_space [get_bd_addr_spaces iop_pmodb/mb/Data] [get_bd_addr_segs PGA_GPIO/S_AXI/Reg] -force
  assign_bd_address -offset 0x41E10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces iop_pmodb/mb/Data] [get_bd_addr_segs PGA_SPI/AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x41800000 -range 0x00010000 -target_address_space [get_bd_addr_spaces iop_pmodb/mb/Data] [get_bd_addr_segs system_interrupts/S_AXI/Reg] -force
